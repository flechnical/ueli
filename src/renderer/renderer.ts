...
import { proportionsCalculatorSettingsComponent } from "./settings/proportions-calculator-settings-component";
...
Vue.component("proportions-calculator-settings", proportionsCalculatorSettingsComponent);
